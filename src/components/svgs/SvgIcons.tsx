...
const StarIcon = ({ width = 20, height = 20, color = "#edb703" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
const HeartIcon = ({ width = 20, height = 20, color = "currentColor", stroke="currentColor" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export { SearchIcon, ArrowDownIcon, StarIcon, HeartIcon }